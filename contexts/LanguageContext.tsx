...
const translations = {
  zh: {
    ...
    'calc.viewAll': '查看完整列表',
    'calc.confirm': '查看范围',
    'calc.rankPosition.title': '位次位置',
    'calc.rankPosition.empty': '输入后显示位置',
    'calc.rankPosition.summary': '约前 {percent}%',
    'calc.rankPosition.beyond': '超出当前数据范围',
    'calc.rankPosition.front': '更靠前',
    'calc.rankPosition.back': '更靠后',
